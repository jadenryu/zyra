        ...
        <div className="container-padding">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-6">
              <Link href="/login" className="hover:text-foreground transition-colors font-medium" style={{color: '#000000'}}>
                Sign in
              </Link>
      ...
      <section className="hero-section section-padding animate-fade-in">
        <div className="container-padding text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg max-w-2xl mx-auto mb-8 font-medium" style={{color: '#000000'}}>
            ...
            {/* Trust indicators */}
            <div className="flex items-center justify-center gap-8 text-sm font-medium" style={{color: '#000000'}}>
      ...
      <section className="section-padding animate-slide-up">
        <div className="container-padding">
          <div className="text-center mb-16">
            ...
            <p className="text-lg max-w-2xl mx-auto font-medium" style={{color: '#000000'}}>
        ...
        <div className="container-padding text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="professional-card">
              ...
              <div className="font-medium" style={{color: '#000000'}}>Datasets processed</div>
            </div>
            <div className="professional-card">
              <div className="text-4xl font-bold text-brand-600 mb-2">500+</div>
              <div className="font-medium" style={{color: '#000000'}}>Companies using Zyra</div>
            </div>
            <div className="professional-card">
              <div className="text-4xl font-bold text-brand-600 mb-2">99.9%</div>
              <div className="font-medium" style={{color: '#000000'}}>Uptime guarantee</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cta-section section-padding">
        <div className="container-padding text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-large mb-8 font-medium" style={{color: '#000000'}}>
          ...
          <div className="grid md:grid-cols-5 gap-8 mb-12">
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-gray-300 hover:text-brand-400 transition-colors">Twitter</a>
                <a href="#" className="text-gray-300 hover:text-brand-400 transition-colors">LinkedIn</a>
                <a href="#" className="text-gray-300 hover:text-brand-400 transition-colors">GitHub</a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li><a href="#" className="text-gray-300 hover:text-background transition-colors">Features</a></li>
                <li><a href="#" className="text-gray-300 hover:text-background transition-colors">Pricing</a></li>
                <li><a href="#" className="text-gray-300 hover:text-background transition-colors">Integrations</a></li>
                <li><a href="#" className="text-gray-300 hover:text-background transition-colors">API</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li><a href="#" className="text-gray-300 hover:text-background transition-colors">Documentation</a></li>
                <li><a href="#" className="text-gray-300 hover:text-background transition-colors">Tutorials</a></li>
                <li><a href="#" className="text-gray-300 hover:text-background transition-colors">Blog</a></li>
                <li><a href="#" className="text-gray-300 hover:text-background transition-colors">Community</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li><a href="#" className="text-gray-300 hover:text-background transition-colors">About</a></li>
                <li><a href="#" className="text-gray-300 hover:text-background transition-colors">Careers</a></li>
                <li><a href="#" className="text-gray-300 hover:text-background transition-colors">Contact</a></li>
                <li><a href="#" className="text-gray-300 hover:text-background transition-colors">Privacy</a></li>
              </ul>
            </div>
          </div>
